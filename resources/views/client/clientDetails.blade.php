      ...
      <!--header-->
       <div id="header" class="header" style="background-color: #FCFFE5; ">
         <nav class="navbar navbar-expand-lg navbar-dark text-capitalize" style="box-shadow: 0px -1px 26px -7px rgba(0,0,0,0.75);">
            <div class="container">
               <a class="navbar-brand" href="#"><img src="/imgs/log.jpg" style="height: auto; width: auto;max-height: 72px;
...
<img src= "/imgs/{{json_decode($client, true)['picture']}}" width='180px;' height='150px;' style="border:1px solid black; padding:2px;  float:left; margin-right:10px; margin-bottom:5px; position:relative; top:15px; left:650px;">

         <h4 name="nnn" style="position: absolute; top:50px; font-family: arial;color: #B22222;font-weight: bold; left:50px">Name:{{json_decode($client, true)['Cname']}}</h4>

         <h4 style="position: absolute; top:110px; left:50px">Email:{{json_decode($client, true)['Cemail']}}</h4>


         <h5  style="position: absolute; top:200px; left:50px">Requested Package:  <input type="text"   id="trnm"       name="tournm"           value="{{json_decode($client, true)['tour']}} {{json_decode($client, true)['hotel']}}"   style="background-color:   #FF6347; border:none; border-radius: 3px; width:180px; padding-left: 5px;"></h5>

           <h5 style="position: absolute; top:250px; left:50px">Total Amount: {{json_decode($client, true)['payable']}}</h5>

   <h5 style="position: absolute; top:300px; left:50px">Status:   <input type="text"   id="status"                  value=" {{json_decode($client, true)['status']}}"   style="background-color:   #FF6347; border:none; border-radius: 3px; width:120px; padding-left: 5px;">  </h5>
           ...
           <div id="rate" style="position: relative; top:60px; left:1220px; background-color: #FFFAF0; height:290px; width:270px; border-radius: 8px; box-shadow: 2px 5px 28px -11px rgba(0,0,0,0.75); ">
               ...
               <!--  <a href="/rate" class="btn btn-success" style="position: relative; top:70px; height:45px; width:220px;margin:10px 25px;  font-size: 20px;" >Submit</a>   -->

                <!--   -->
            </div>

             <a href="/logout"   class="btn btn-danger" style="position: absolute; top:450px;left:1000px; height:45px; width:140px;margin:10px 25px;  font-size: 20px;">Logout</a>

              <a href="/pdf/{{json_decode($client, true)['id']}}"   class="btn btn-success" style="position: absolute; top:450px;left:895px; height:45px; width:90px;margin:10px 25px;  font-size: 20px;">Pdf</a>
</form>
        </div>
         ...
         <nav>
            ...
            <ul>
                <li><a class="" href=""></a></li>
                 <li><a class="" href=""></a></li>
               <li><a class="active" href="/home"><i class="fa fa-home"></i> &nbsp &nbsp Home</a></li>
               ...
               <li><a href=""><i class="fa fa-user-circle"></i> &nbsp &nbspBlog</a></li>
