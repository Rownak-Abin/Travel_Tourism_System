...
<body style="overflow-x: hidden; height: auto; background-color: #f4f4f4">
         ...
         <nav>
            ...
            <ul>
                <li><a class="" href=""></a></li>
                 <li><a class="" href=""></a></li>
               <li><a class="active" href=""> &nbsp &nbsp Home</a></li>
   ...
   <div>
    <form method="post" enctype="multipart/form-data">
      ...
      <input type="hidden" name="_token" value="{{csrf_token()}}">
        ...
        <input type="text" id="nm"  value="{{$details->hname}}" name="hotelnm"  style="position: relative; font-size:47px; left:320px; top:115px; text-shadow: 2px 2px 5px red;">
 ...
 <div >
    ...
    <div id="map" style="position: relative; height:350px; width:790px; top:115px; left:322px; background-color: red; display: none;">
      ...
      <img src="{{asset('imgs/'.$details->map)}}" style="position: relative; height:350px; width:790px; top:0px; left:0px; box-shadow: 2px 5px 28px -11px rgba(0,0,0,0.75); ">

    </div>

      <!--fotoroma div-->
     <div class="fff"  style="position: relative; left:322px; top:140px; box-shadow: 0px -1px 26px -7px rgba(0,0,0,0.75); height:500px; width:790px; ">
        <img src="{{asset('imgs/'.$details->pictwo)}}" style="height:500px; width:790px;">
  ...
  <!--price duration-->
        <div style="position: relative; top:180px; left:322px; background-color: #D3FAFC; width:790px; height:250px; border-radius: 8px; box-shadow: 2px 5px 28px -11px rgba(0,0,0,0.75);">
              <div style="position: absolute; background-color: #30AE30; width:790px; height:55px;     border-top-left-radius:8px; border-top-right-radius:8px; ">
                    ...
                    <h4 style="position: relative;top:10px; left:30px; color: white; ">Room Tarrif</h4>
                    
              </div>


              <h4 style="position: relative; font-family: serif; ; top:90px; left:50px">Per Night cost:      {{$details->price}}</h4>

              <h4 style="position: relative; font-family: serif ; top:110px; left:50px">Tour Duration:     11AM -11AM (24 hours)   </h4>
      ...
      <div style="position: relative; height:auto; width:270px; background-color:#000; top:0px; left:1170px; border: 1px solid #C0C0C0; border-radius: 5px;  box-shadow: 2px 5px 28px -11px rgba(0,0,0,0.75);">
               ...
               <input id="cost" value="{{$details->price}}" type="text" name="cos" style="position: relative; height:50px; padding:10px; width:220px;margin:5px 25px;  font-size: 20px;">     

                <div style="position: relative;left:85px; color:#fff;  font-size: 17px; top:-0px">--Nights--</div>  
   ...
   @foreach($errors->all() as $err)
            ...
            $('#map').toggle(400);
              ...
              <!--footer-->
             <footer style="position: relative; top:1200px; left:200px; width:auto">
         <div class="container">
            <div class="row">
